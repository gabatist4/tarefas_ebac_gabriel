...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (!isCamposValidos(nome, cpf, tel)) {
    ...
    private void tabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
        ...
        Long Tel = (Long) tabelaClientes.getValueAt(linhaSelecionada, 2);
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            if (!isCamposValidos(nome, cpf.toString(), tel)) {
                JOptionPane.showMessageDialog(this, "Faltam preencher campos obrigatórios!");
                return;
            }

            Cliente clienteNovo = new Cliente(nome, cpf.toString(), tel, null, null, null, null);
